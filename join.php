          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="simple-text">Let's contribute with us</h4>
              </div>
                <div class="card-body">
                   <form method="post" action="proses_join.php">
                    <div class="col-md-3 px-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="username" placeholder="tegalsec">
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" class="form-control" name="email" placeholder="tegalsec@mail.com">
                      </div>
                    </div>

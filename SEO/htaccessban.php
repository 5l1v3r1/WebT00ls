...
<body class="">
  <div class="wrapper">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
      <div class="content">
<h2 class="text-center">Htaccess Ban Generator</h2>
<?php
error_reporting(0);
function fnExecute(){
...
<div class="tile">
  <div class="col-md-12">
    <form method="get">
      <textarea name="ips" rows="8" cols="80" class="form-control mb-3"></textarea>
    ...
    <div class="col-md-12">
      ...
      <input type="submit" class="btn btn-block" value="Create .htaccess" />
        <div class="clear"></div>
        <br />
      </form>

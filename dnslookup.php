      ...
      ?>
              ...
              <form method="post">
                  <div class="form-inline">
                      ...
                      <input id="domain" type="text" name="domain" class="form-control" value="<?=empty($_POST['domain'])?'':htmlentities($_POST['domain'])?>">
                      <button type="submit" class="btn btn-block">lookup</button>
              </form>

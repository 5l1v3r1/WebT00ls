...
<body class="">
  <div class="wrapper">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="card">
				<textarea class="form-control" rows="8" id="copeh" readonly="readonly" placeholder="Hasil Obfuscate"><?= $sec; ?></textarea>
			</div>
		</div>
	</div>
<div class="tile">
	<div class="row">
		<div class="col">
			<button type="submit" name="enc" class="btn btn-block">Obfuscate</button>
		</div>
		</form>
		<div class="col">
			<button type="button" onclick="Copy()" name="enc" class="btn btn-block">Copy Code</button>
		</div>
	</div>
</div>

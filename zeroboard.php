...
<body class="">
  <div class="wrapper">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
      <div class="content">
<h2 class="text-center">Zero Board Exploit</h2>
<div class="tile">
  <div class="col-md-12">
    <?php
    ...
    <input type="text" class="form-control" name="victim" size="25" value="http://site.com/board/" />
    <input type="submit" class="btn btn-block" value="Excute" name="exp" />
    <p>Refrensi:
    </p>
    <p><a target="_blank" href="https://www.exploit-db.com/exploits/9590"</a>https://www.exploit-db.com/exploits/9590</p>
    <p><a target="_blank" href="https://www.exploit-db.com/exploits/25125"</a>https://www.exploit-db.com/exploits/25125</p>
    <p><a target="_blank" href="https://www.cvedetails.com/vulnerability-list/vendor_id-1344/Zeroboard.html"</a>https://www.cvedetails.com/vulnerability-list/vendor_id-1344/Zeroboard.html</p>
    </form>
    <pre>
    <?php
    	print_r($res);

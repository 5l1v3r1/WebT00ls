...
Tegal N00bs Hacker dulunya hanya merupakan sebuah situs web biasa yang berfokus pada dunia IT. Namun dengan seiringnya waktu, Tegal N00bs Hacker kini menjadi sebuah komunitas IT aktif yang berada di kota Tegal dengan memiliki beberapa kegiatan seperti seminar, sharing session, mini gath dan sebagainya. Kami juga memiliki nickname Tegal1337. Komunitas ini terbuka untuk siapa saja yang ini belajar mengenai dunia IT.
                </div>
              </div>
              <div class="card-footer">
                <div class="button-container">
                  <button href="https://www.facebook.com/tegal1337" class="btn btn-icon btn-round btn-facebook">
                    <i class="fab fa-facebook"></i>
                  </button>
                  <button href="https://github.com/tegal1337" class="btn btn-icon btn-round btn-github">
                    <i class="fab fa-github"></i>
                  </button>
                  <button href="https://instagram.com/tegal1337" class="btn btn-icon btn-round btn-instagram">
